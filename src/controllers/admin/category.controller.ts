...
export class CategoryController {
    ...
    async create(
        ...
        try {
            ...
            if (body.name !== undefined) {
                ...
                if (exists) return response(res, StatusCodes.BAD_REQUEST, "Category with this name already exists");
                doc.name = body.name;
            }
            ...
            return response(res, StatusCodes.CREATED, "Category created successfully", doc);
        } catch (error: any) {
    ...
    async edit(
        ...
        try {
            ...
            if (!doc) return response(res, StatusCodes.NOT_FOUND, "Category not found");
            ...
            await this.repo.save(doc);
            return response(res, StatusCodes.OK, "Category updated successfully", doc);
        } catch (error: any) {
            return handleErrorResponse(error, res);
        }
    }
